                    ...
                    <div class="content">
                        ...
                        @if(!$user->isSuperAdmin())
                            <div class="actions">
                                ...
                                <div class="crud">
                                    <a href="{{ Route::has('users.edit') ? route('users.edit', ['uuid' => $user->uuid]) : '#' }}" wire:navigate>
                        ...
                        @else
                            <div class="actions">
                                <div class="others">
                                    <span class="text-sm">{{ $user->status->label() }}</span>
                                </div>
                                <div class="crud">
                                    <span class="text-sm">{{ $user->role->label() }}</span>
                                </div>
                            </div>
                        @endif
                    </div>
