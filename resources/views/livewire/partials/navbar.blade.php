    ...
    <div class="container">
        ...
        <div class="nav_links" :class="{ 'open' : open }">
            <div class="main_links">
                ...
                <a href="{{ Route::has('home-page') ? route('home-page') : '#' }}" class="{{ Route::currentRouteName() === route('home-page') ? 'active' : '' }}" wire:navigate>Home</a>
                <a href="{{ Route::has('about-page') ? route('about-page') : '#' }}" class="{{ Route::currentRouteName() === route('about-page') ? 'active' : '' }}" wire:navigate>About</a>
                ...
                >
                    ...
                    <button
                        ...
                        :class="{ 'active': open || '{{ Route::currentRouteName() === 'tours-page' }}' }"
                    >
                        <span>Tours</span>
                ...
                <a href="{{ Route::has('destinations-page') ? route('destinations-page') : '#' }}" class="{{ Route::currentRouteName() === route('destinations-page') ? 'active' : '' }}" wire:navigate>Destinations</a>
                <a href="{{ Route::has('contact-page') ? route('contact-page') : '#' }}" class="{{ Route::currentRouteName() === route('contact-page') ? 'active' : '' }}" wire:navigate>Contact</a>
            </div>
